...
Term: Summer Session II 2025

Department: COMP

Course Number: 110

Course Website: <https://comp110-25ss.github.io/>


Instructor: [Alyssa Byrnes-Lytle](https://alyssalytle.github.io/)

* Office: Fred Brooks Building FB 136
...
* Monday-Thursday there will be online readable and/or video lessons and corresponding assignments for you to complete on Gradescope.

* Friday will be quiz day where you are quizzed on previously learned concepts.

* The Team and I will be available throughout the week to answer questions on our [class social media site](www.edstem.org).
...
Quizzes and the Final Exam will be held via Gradescope. You will have 90 minutes to complete each quiz and 3 hours to complete the final exam. You can start it at any time the day of the exam.

<!-- **Final Exam Makeup**

Students who have 3 exams in 24 hours or a conflicting final exam (at 8am on Thursday, May 1st) must attend the final exam makeup, which will be held at 12pm on Sunday, May 4th in SN014.  If this applies to you, please complete the following forms as soon as possible:

1. UNC's Official [Final Exam Excuse Form](https://eef.oasis.unc.edu/)
2. Our [internal form for tracking requests](https://airtable.com/appJjqVMSOFr9kspg/pagwo6pZBDYvx2s3F/form) -->

### Office Hours

Office Hours are perhaps the most valuable resource in COMP110. They will be available remotely. Please find the Office Hours under the Support tab on this site.
...
* 50% - Preparation, Practice, Participation
  ...
  * 5% - (RD) Reading Responses
  * 5% - (LS) Async Lesson Responses on Gradescope (Graded for Correctness)
  * 5% - (CQ) Challenge Questions (Graded for Correctness)
* 50% - Mastery
  * 40% - 4x Quizzes
  * 10% - Final Exam
...
The cumulative final exam is worth 50% of your final grade at the start of the term. Each quiz you take accounts for 10% of your final grade and reduces the weight of your final examination by 10%. There are no quiz drops.
...
<!-- To request absence from a quiz, you should submit [this form](https://airtable.com/appJjqVMSOFr9kspg/pagwai6933foGwE0w/form) before your absence. -->

To ensure these assessments are fair for all students enrolled in COMP110 this term, we can only offer quiz makeups for officially documented university approved absences. Merely being absent from a quiz that is not university approved results in the quiz’s credit not be drawn down from your final exam score’s weight. As such, this is not a penalty; your mastery of this quiz’ material will be assessed on the cumulative final exam.
...
You absolutely may, and are encouraged to, discuss general course concepts (i.e. not assignment-specific) material with anyone, including other current students and tutors. This includes going over lecture slides, documentation, code examples covered in lecture, practice quizzes, etc. The examples you use to discuss general course materials must be from lecture or your own creativity, you cannot use examples directly drawn from any assignments handed in.
...
Lesson responses, challenge questions, and programming exercises will all have deadlines and late periods. After the late period begins, there is a 1-hour grace period in which no penalty is applied. Beyond that grace period, the following policies apply:

Challenge Question responses on Gradescope are assigned on some lecture days and must be completed before 11:59pm the same day unless noted otherwise. If handed in after the 1-hour grace period described above, a 5% late penalty will be applied for each day it is late, capping at 80%, at the end of the semester. No lesson responses will be accepted beyond 11:59pm four days following the original deadline. To ensure fairness to everyone, as emergencies may arise, we will drop the two lowest lesson scores, and two lowest challenge question response scores, including zeros.

Programming and reading assignments - submissions made after the deadline, outside of the 1-hour grace period described above, will have a 5% late penalty applied for each day it is late (e.g., if you submit one day late, the highest grade you could get is a 95%; after two days, you could get a 90%), capping at 80%. Exercises cannot be handed in beyond their 6-day late period, which follows the original deadline.
...
* Lessons: 60% (e.g. forgiven up to 4x late lesson penalties)
* Exercises: 30% (e.g. forgiven up to 2x late exercise penalties)
* Readings: 15% (e.g. forgiven up to 1x late reading assignment)
...
If you have suggestions on how to improve the course or just want to leave some positive, encouraging feedback for the TAs or me, please <a href="https://airtable.com/appB1qPsdKZhVAxvF/pag4p6kfIuixxRcWm/form" target="_blank">give us feedback</a>. If you make a suggestion we're able to act on, while we still have time to, we're more than happy to adapt based on your feedback!
