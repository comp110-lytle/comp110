...
* Include attributes such as make, model, year, color, and mileage.  
...
* Implement a method called `calculate_depreciation` to calculate the depreciation of the car based on its mileage and `depreciation_rate: float` 
