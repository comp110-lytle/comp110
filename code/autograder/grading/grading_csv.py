...
GS_ASSIGNMENT_EXPORT_1: str = 'assignment_1634500_export'
GS_ASSIGNMENT_EXPORT_2: str = 'assignment_1634507_export'

# set this to be whatever the url is when you open the gradescope assignment and click on manage submissions
GS_SUBMISSIONS_1: str = "https://www.gradescope.com/courses/288698/assignments/1634500/submissions"
GS_SUBMISSIONS_2: str = "https://www.gradescope.com/courses/288699/assignments/1634507/submissions"
...
def main() -> None:
    ...
    subs1: list[str] = os.listdir(GS_ASSIGNMENT_EXPORT_1)
    subs2: list[str] = os.listdir(GS_ASSIGNMENT_EXPORT_2)
    all_subs: list[str] = subs1 + subs2
    ...
    for i in range(len(all_subs)):
        ...
        if 'yml' not in sub_num:
            ...
            if i < len(subs1):
                urls.append(GS_SUBMISSIONS_1 + "/" + sub_num)
            else:
                urls.append(GS_SUBMISSIONS_2 + "/" + sub_num)
