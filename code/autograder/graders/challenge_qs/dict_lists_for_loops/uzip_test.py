...
@mark.weight(1)
def test_gk_params():
    """Part 2.1. get_keys should take a dict[str, int] as a parameter"""
...
def test_gk_return_type():
    """Part 2.1. get_keys should return a list[str]"""
...
@mark.weight(1)
def test_gk_empty():
    """Part 2.1. get_keys called with an empty dict should return an empty list."""
    module = reimport_module(MODULE)
    a: dict[str,int] = {}
...
def test_gk_nonempty():
    """Part 2.1. get_keys basic functionality."""
    module = reimport_module(MODULE)
...
@mark.weight(1)
def test_gv_params():
    """Part 2.2. get_values should take a dict[str, int] as a parameter"""
    module = import_module(MODULE) 
...
def test_gv_return_type():
    """Part 2.2. get_values should return a list[int]"""
    module = reimport_module(MODULE)
...
@mark.weight(1)
def test_gv_empty():
    """Part 2.2. get_values called with an empty dict should return an empty list."""
    module = reimport_module(MODULE)
    a: dict[str,int] = {}
...
def test_gv_nonempty():
    """Part 2.2. get_values basic functionality."""
    module = reimport_module(MODULE)
    a: dict[str,int] = {"Math": 110, "Comp": 210, "Chem": 100}
    check = module.get_values(a)
