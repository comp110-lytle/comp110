...
def test_w_sum_params():
    """Part 1.1. w_sum should take a list of floats as a parameter"""
    module = reimport_module(MODULE)
...
def test_sum_return_type():
    """Part 1.1. w_sum should return a float"""
    module = reimport_module(MODULE)
...
@mark.weight(1)
def test_sum_empty():
    """Part 1.1. w_sum of empty list should be 0.0"""
    module = reimport_module(MODULE)
...
def test_sum_positive():
    """Part 1.1. w_sum of positive floats should be correct"""
    module = reimport_module(MODULE)
...
def test_sum_negative():
    """Part 1.1. w_sum of positive and negative floats should be correct"""
    module = reimport_module(MODULE)
...
def test_f_sum_params():
    """Part 1.2. f_sum should take a list of floats as a parameter"""
    module = reimport_module(MODULE)
...
def test_fsum_return_type():
    """Part 1.2. f_sum should return a float"""
    module = reimport_module(MODULE)
...
@mark.weight(1)
def test_fsum_empty():
    """Part 1.2. f_sum of empty list should be 0.0"""
    module = reimport_module(MODULE)
    assert module.f_sum([]) == 0.0
    
@mark.weight(1)
def test_fsum_positive():
    """Part 1.2. f_sum of positive floats should be correct"""
    module = reimport_module(MODULE)
    test_list: list[float] = [2.0, 2.0, 3.0]
...
def test_fsum_negative():
    """Part 1.2. f_sum of positive and negative floats should be correct"""
    module = reimport_module(MODULE)
    test_list: list[float] = [1.0, -3.0, 4.0]
...
def test_f_range_sum_params():
    """Part 1.3. f_range_sum should take a list of floats as a parameter"""
    module = reimport_module(MODULE)
...
def test_f_range_sum_return_type():
    """Part 1.3. f_range_sum should return a float"""
    module = reimport_module(MODULE)
...
def test_f_range_sum_empty():
    """Part 1.3. f_range_sum of empty list should be 0.0"""
    module = reimport_module(MODULE)
    assert module.f_range_sum([]) == 0.0
    
@mark.weight(1)
def test_f_range_sum_positive():
    """Part 1.3. f_range_sum of positive floats should be correct"""
    module = reimport_module(MODULE)
    test_list: list[float] = [2.0, 2.0, 3.0]
...
def test_f_range_sum_negative():
    """Part 1.3. f_range_sum of positive and negative floats should be correct"""
    module = reimport_module(MODULE)
    test_list: list[float] = [1.0, -3.0, 4.0]
