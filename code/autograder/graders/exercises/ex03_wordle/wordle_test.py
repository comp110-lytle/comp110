...
@mark.weight(2)
def test_input_guess_correctly_declared():
...
def test_part_3_input_guess_correct_implementation_correct_length(capsys, monkeypatch):
    """Part 1. `input_guess` - function is correctly implemented (correct lengths)"""
    module = reimport_module(MODULE)
...
def test_part_3_input_guess_correct_implementation_incorrect_length(capsys, monkeypatch):
    """Part 1. `input_guess` - function is correctly implemented (incorrect lengths)"""
    module = reimport_module(MODULE)
...
def test_part_1_contains_char_correctly_declared():
    """Part 2. `contains_char` - function is correctly declared (name, parameter types, return type)."""
    module = reimport_module(MODULE)
...
def test_part_1_contains_char_correctly_implemented():
    """Part 2. `contains_char` - function is correctly implemented."""
    module = reimport_module(MODULE)
...
def test_part_1_contains_char_throws():
    """Part 2. `contains_char` - throws assertion error with wrong second argument length."""
    module = reimport_module(MODULE)
    contains_char = module.contains_char
...
def test_part_2_emojified_correctly_declared():
    """Part 3. `emojified` - function is correctly declared (name, parameter types, return type)."""
    module = reimport_module(MODULE)
...
def test_part_2_emojified_correctly_implemented():
    """Part 3. `emojified` - function is correctly implemented."""
    module = reimport_module(MODULE)
...
def test_part_2_emojified_calls_contains_char():
    """Part 3. `emojified` - function must call contains_char."""
    module = reimport_module(MODULE)
    try:
...
def test_part_2_emojified_throws():
    """Part 3. `emojified` - throws assertion error with non-equal lengths of parameters."""
    module = reimport_module(MODULE)
    contains_char = module.contains_char
    with raises(AssertionError):
...
def test_part_4_main_correctly_declared():
    ...
    assert_parameter_list(module.main, [str])
...
def test_part_4_main_correctly_implemented_parameter(capsys, monkeypatch):
    """Part 4. `main` - game is winnable with secret other than "codes"."""
    module = reimport_module(MODULE)
