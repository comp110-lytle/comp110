    ...
    if all_passed:
        ...
        for test in test_results:
            for code in test.error_codes:
                print(code)
        print("\nFor information on how to fix: https://20ss2.comp110.com/diagnostic-codes.html" + bcolors.END)
        print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n")
...
def test_git_upstream() -> Check_Result:
    ...
    try:
        ...
        if 'https://github.com/COMP110-20ss2/course-material.git' in upstream:
    ...
    git_upstream_test.status = True if 'https://github.com/COMP110-20ss2/course-material.git' in upstream else False
